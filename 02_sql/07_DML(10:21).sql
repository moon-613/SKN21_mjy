-- 10/21(화)
-- edit > preferences > SQL editor > safr updates 체크 해제.
-- 다시 이해가 조금 되고 재밌어짐 ㅠㅠ 드디어 이해가 되고 문제가 풀림.
...
update emp 
set    comm_pct = null  -- where절에서는 is null이지만 여기선 null 대입하는 거라 = null
where  emp_id = 100;


/* *********************************************************************
DELETE : 테이블의 행을 삭제. 컬럼과 관계 없이 실행.
구문 
